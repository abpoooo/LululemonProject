            ...
            >
                <form className='CheckoutUpdate'>
                    ...
                    <div className='CheckoutUpdate_Right'>
                        ...
                        <div className='Checkout_Right_ProductName' style={{fontSize:'20px',fontWeight:'bold', margin:'5px'}}>{order?.product}</div>
                        <div className='Checkout_Right_Price' style={{fontSize:'12px', margin:'5px'}}>${order?.price.toFixed(2)}</div>
                        <div className='Checkout_Right_ColorName' style={{fontSize:'12px',margin:'5px'}}>Color:{order?.color}</div>
                        <div className='Checkout_Right_ColorSelector' style={{margin:'5px'}}>
                            {order?.swatches.map((element, index) =>
                                <img
                                    ...
                                    style={{height:'24px', width:'24px', margin:'0 5px 0 5px' ,border: element.colorId === colorSelection ? '2px solid black' : '2px solid white'}}
                                />
                            )}
                        </div>
                        <div className='CheckoutUpdate_Right_Size' style={{fontSize:'12px',margin:'0 5px',paddingLeft:'0'}} >Size: {order?.size}</div>
                        <div className='CheckoutUpdate_Right_SizeSelector' style={{fontSize:'12px',margin:'0 5px',paddingLeft:'0'}}>
